...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        l5.setFont(new Font("Courier New", Font.BOLD, 12));
        
        l6 = new JLabel("It would appear on ATM Card/Cheque Book and Statements");
        l6.setFont(new Font("Courier New", Font.BOLD, 12));
        ...
        l9.setFont(new Font("Courier New", Font.BOLD, 12));
    
        l10 = new JLabel("Services Required:");
        l10.setFont(new Font("Courier New", Font.BOLD, 18));
        
        l11 = new JLabel("Form No:");
        l11.setFont(new Font("Courier New", Font.BOLD, 14));
        
        l12 = new JLabel(formno);
        l12.setFont(new Font("Courier New", Font.BOLD, 14));
